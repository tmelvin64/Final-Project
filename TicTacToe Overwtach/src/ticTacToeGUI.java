...
public class ticTacToeGUI extends javax.swing.JFrame {
    ...
    ImageIcon Hollywood=new ImageIcon(getClass().getResource("Hollywood.png")), Dorado=new ImageIcon(getClass().getResource("Dorado.png")),
            Hanamura=new ImageIcon(getClass().getResource("Hanamura.png")), Volskaya=new ImageIcon(getClass().getResource("Volskaya.png")),
            Numbani=new ImageIcon(getClass().getResource("Numbani.png")); //Initialize pictures
    
    ImageIcon BastionP=new ImageIcon(getClass().getResource("/Bastion/BastionP.png")), DVaP=new ImageIcon(getClass().getResource("/DVa/DVaP.png")),
            GenjiP=new ImageIcon(getClass().getResource("/Genji/GenjiP.png")), HanzoP=new ImageIcon(getClass().getResource("/Hanzo/HanzoP.png")),
            JunkratP=new ImageIcon(getClass().getResource("/Junkrat/JunkratP.png")), LucioP=new ImageIcon(getClass().getResource("/Lucio/LucioP.png")),
            McCreeP=new ImageIcon(getClass().getResource("/McCree/McCreeP.png")), MeiP=new ImageIcon(getClass().getResource("/Mei/MeiP.png")),
            MercyP=new ImageIcon(getClass().getResource("/Mercy/MercyP.png")), PharahP=new ImageIcon(getClass().getResource("/Pharah/PharahP.png")),
            ReaperP=new ImageIcon(getClass().getResource("/Reaper/ReaperP.png")), ReinhardtP=new ImageIcon(getClass().getResource("/Reinhardt/ReinhardtP.png")),
            RoadhogP=new ImageIcon(getClass().getResource("/Roadhog/RoadhogP.png")), Soldier76P=new ImageIcon(getClass().getResource("/Soldier76/Soldier76P.png")),
            SymmetraP=new ImageIcon(getClass().getResource("/Symmetra/SymmetraP.png")), TorbjornP=new ImageIcon(getClass().getResource("/Torbjorn/TorbjornP.png")),
            TracerP=new ImageIcon(getClass().getResource("/Tracer/TracerP.png")), WidowmakerP=new ImageIcon(getClass().getResource("/Widowmaker/WidowmakerP.png")),
            WinstonP=new ImageIcon(getClass().getResource("/Winston/WinstonP.png")), ZaryaP=new ImageIcon(getClass().getResource("/Zarya/ZaryaP.png")),
            ZenyattaP=new ImageIcon(getClass().getResource("/Zenyatta/ZenyattaP.png"));
    
    ImageIcon BastionU=new ImageIcon(getClass().getResource("/Bastion/BastionU.png")), DVaU=new ImageIcon(getClass().getResource("/DVa/DVaU.png")),
            GenjiU=new ImageIcon(getClass().getResource("/Genji/GenjiU.png")), HanzoU=new ImageIcon(getClass().getResource("/Hanzo/HanzoU.png")),
            JunkratU=new ImageIcon(getClass().getResource("/Junkrat/JunkratU.png")), LucioU=new ImageIcon(getClass().getResource("/Lucio/LucioU.png")),
            McCreeU=new ImageIcon(getClass().getResource("/McCree/McCreeU.png")), MeiU=new ImageIcon(getClass().getResource("/Mei/MeiU.png")),
            MercyU=new ImageIcon(getClass().getResource("/Mercy/MercyU.png")), PharahU=new ImageIcon(getClass().getResource("/Pharah/PharahU.png")),
            ReaperU=new ImageIcon(getClass().getResource("/Reaper/ReaperU.png")), ReinhardtU=new ImageIcon(getClass().getResource("/Reinhardt/ReinhardtU.png")),
            RoadhogU=new ImageIcon(getClass().getResource("/Roadhog/RoadhogU.png")), Soldier76U=new ImageIcon(getClass().getResource("/Soldier76/Soldier76U.png")),
            SymmetraU=new ImageIcon(getClass().getResource("/Symmetra/SymmetraU.png")), TorbjornU=new ImageIcon(getClass().getResource("/Torbjorn/TorbjornU.png")),
            TracerU=new ImageIcon(getClass().getResource("/Tracer/TracerU.png")), WidowmakerU=new ImageIcon(getClass().getResource("/Widowmaker/WidowmakerU.png")),
            WinstonU=new ImageIcon(getClass().getResource("/Winston/WinstonU.png")), ZaryaU=new ImageIcon(getClass().getResource("/Zarya/ZaryaU.png")),
            ZenyattaU=new ImageIcon(getClass().getResource("/Zenyatta/ZenyattaU.png"));
    ...
    private void setFontsEtc() { //Set custom Smite font and other 'extra' things.
        try {
            Font font = Font.createFont(Font.TRUETYPE_FONT, this.getClass().getResourceAsStream("/Fonts/TextFont.ttf")).deriveFont(Font.BOLD, 13);
            lblTie.setFont(font);
            lblTeam1.setFont(font);
            lblTeam2.setFont(font);
            lblInfo.setFont(font);
            
            Font fontRespawn = Font.createFont(Font.TRUETYPE_FONT, this.getClass().getResourceAsStream("/Fonts/TextFont.ttf")).deriveFont(Font.PLAIN, 14);
            lblRespawn.setFont(fontRespawn);
            lblQuit.setFont(fontRespawn);
            
            Font fontScore = Font.createFont(Font.TRUETYPE_FONT, this.getClass().getResourceAsStream("/Fonts/TextFont.ttf")).deriveFont(Font.BOLD, 14);
    ...
    private void playHero(String heroName, String soundName) { //Hero sounds
        hero = this.getClass().getResourceAsStream("/"+heroName+"/"+heroName+soundName+".wav");
    ...
    private void playTie(String soundName) { //Tie sounds
        tie = getClass().getResourceAsStream("/OtherSounds/"+soundName+".wav");
    ...
    private void initComponents() {
        ...
        btnRematch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/button.png"))); // NOI18N
        btnRematch.setBorderPainted(false);
        btnRematch.setContentAreaFilled(false);
        btnRematch.setFocusable(false);
        btnRematch.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/buttonHover.png"))); // NOI18N
        ...
        btnQuit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/button.png"))); // NOI18N
        btnQuit.setBorderPainted(false);
        btnQuit.setContentAreaFilled(false);
        btnQuit.setFocusable(false);
        btnQuit.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/buttonHover.png"))); // NOI18N
        ...
        picBG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Hollywood.png"))); // NOI18N
