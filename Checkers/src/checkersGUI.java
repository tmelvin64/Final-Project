...
public class checkersGUI extends javax.swing.JFrame {
    ...
    ImageIcon RedS = new ImageIcon(getClass().getResource("/images/RedS.png"));
    ImageIcon RedKing = new ImageIcon(getClass().getResource("/images/RedKing.png"));
    ImageIcon RedKingS = new ImageIcon(getClass().getResource("/images/RedKingS.png"));
    ImageIcon Black = new ImageIcon(getClass().getResource("/images/Black.png"));
    ImageIcon BlackS = new ImageIcon(getClass().getResource("/images/BlackS.png"));
    ImageIcon BlackKing = new ImageIcon(getClass().getResource("/images/BlackKing.png"));
    ImageIcon BlackKingS = new ImageIcon(getClass().getResource("/images/BlackKingS.png"));
    
    ImageIcon nullRedS = new ImageIcon(getClass().getResource("/images/RedEmptyS.png"));
    ImageIcon nullBlackS = new ImageIcon(getClass().getResource("/images/BlackEmptyS.png"));
    
    ImageIcon RedBoard = new ImageIcon(getClass().getResource("/images/CheckersBoardRed.png"));
    ImageIcon BlackBoard = new ImageIcon(getClass().getResource("/images/CheckersBoardBlack.png"));
    ...
    private void blackMoveCheck() {
        ...
        lblInfo.setText("Lunar Republic's turn.");
        
        if (!blackJump.isEmpty()) {
            lblInfo.setText("Lunar Republic's turn. A capture must be made!");
            for (int y=0; y<8; y++) {
                for (int x=0; x<8; x++) {
                    if (space[x][y] != null) {
                        space[x][y].setEnabled(false);
    ...
    private void redMoveCheck() {
        ...
        lblInfo.setText("Solar Empire's turn.");
        if (!redJump.isEmpty()) {
            lblInfo.setText("Solar Empire's turn. A capture must be made!");
            for (int y=0; y<8; y++) {
                for (int x=0; x<8; x++) {
                    if (space[x][y] != null) {
                        space[x][y].setEnabled(false);
    ...
    private void playTada() { //Bart announcer pack
        tada = this.getClass().getResourceAsStream("/sounds/Tada.wav");
        bufferTada = new BufferedInputStream(tada);
        try {
            AudioInputStream audioInputStreamTada = AudioSystem.getAudioInputStream(bufferTada);
            Clip clipTada = AudioSystem.getClip();
    ...
    private void initComponents() {
        ...
        setTitle("Celestial Checkers");
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setIconImage(new ImageIcon(getClass().getResource("/images/CheckersIcon.png")).getImage());
        ...
        imgBoard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/CheckersBoardBlack.png"))); // NOI18N
