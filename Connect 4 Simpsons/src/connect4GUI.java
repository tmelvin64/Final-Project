...
public class connect4GUI extends javax.swing.JFrame {
    ...
    public connect4GUI() {
        ...
        try {
        Font font = Font.createFont(Font.TRUETYPE_FONT, this.getClass().getResourceAsStream("/Font/Simpsonfont.ttf")).deriveFont(Font.PLAIN, 13);
    ...
    private void playSound(String soundName, int soundNumber) { //sound FX
        if (!mute) {
            System.out.println("/Sounds/"+soundName+Integer.toString(rndNum)+".wav");
            Sound = this.getClass().getResourceAsStream("/Sounds/"+soundName+Integer.toString(rndNum)+".wav");
    ...
    private void initComponents() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/images/YellowSmall.png")).getImage());
